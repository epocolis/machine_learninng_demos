...
# usage ./sync_from_s3.sh opt/ml/input/data my_bucket xgboost_anomaly_detection/opt/ml/input/data AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY
...
if [ -z "$1" ] || [ -z "$2" ] || [ -z "$3" ] || [ -z "$4" ] || [ -z "$5" ]; then
    handle_error "Missing arguments. Usage: ./sync_from_s3.sh <local_path> <bucket_name> <s3_path> <aws_access_key_id> <aws_secret_access_key>"
fi
