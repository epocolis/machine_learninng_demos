...
python perform_rca_with_logistic_regression.py --model_path $MODEL_PATH --production_data_path $PRODUCTION_DATA_PATH --output_dir $OUTPUT_DIR
...
echo "Classification and RCA completed successfully."
